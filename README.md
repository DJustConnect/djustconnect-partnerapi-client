...
<pre><code>
        [Fact]
        public async Task GetDarStatusWithFilter()
        {
            // Arrange
            ...
            // Act
            var okResult = await _client.GetDarStatusAsync(filter);
            // Assert
        ...
        [Fact]
        public async Task GetRarStatusWithFilter()
        {
            // Arrange
        ...
        [Fact]
        public async Task GetFarmStatusWithFilter()
        {
            // Arrange
            ...
            // Act
            var okResult = await _client.GetFarmStatusAsync(filter);
...
<pre><code>
        ...
        [Fact]
        public async void DeactivatePushNotificationEndpoint()
        {
...
<pre><code>
        ...
        public async Task GetFarmIdTypes()
        {
            ...
            // Act
            var farmIdTypes = await _client.GetFarmIdTypesAsync();
...
<pre><code>
        public async Task&lt;EndpointDTO&gt; GetEndpointAsync()
        {
            return await GetEndpointAsync(CancellationToken.None);
        }
