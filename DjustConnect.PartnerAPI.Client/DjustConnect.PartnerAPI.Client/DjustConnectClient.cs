...
namespace DjustConnect.PartnerAPI.Client
{
  ...
  //      public DjustConnectClient(System.Net.Http.HttpClient httpClient) : base(httpClient)
  //      {
  //          _httpClient = httpClient;
  //      }

		//public static System.Net.Http.HttpClient CreateHttpClient(string thumbprint, string subscriptionkey)
		//{
		...
		//	{
		//		throw new InvalidOperationException($"Certificate not found for CN=client.ikmnet.be in LocalMachine/My.");
		//	}
